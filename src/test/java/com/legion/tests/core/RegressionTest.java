...
//	    	loginToLegionAndVerifyIsLoginDone(propertyMap.get("DEFAULT_USERNAME"),propertyMap.get("DEFAULT_PASSWORD"));
	...
	public void verifyScheduleClopeningAsInternalAdmin(String browser, String username, String password, String location)
		...
		newShiftPage.moveSliderAtCertainPoint(propertyCustomizeMap.get("INCREASE_START_TIME_CLOPENING"), ScheduleNewUITest.shiftSliderDroppable.StartPoint.getValue());
		...
		newShiftPage.customizeNewShiftPage();
		newShiftPage.moveSliderAtCertainPoint(propertyCustomizeMap.get("INCREASE_END_TIME_CLOPENING"), ScheduleNewUITest.shiftSliderDroppable.EndPoint.getValue());
...
//	    	loginToLegionAndVerifyIsLoginDone(propertyMap.get("DEFAULT_USERNAME"),propertyMap.get("DEFAULT_PASSWORD"));
	...
	public void viewAndFilterScheduleWithGroupByAllDayViewAsStoreManager(String browser, String username, String password, String location)
		...
		schedulePage = dashboardPage.goToTodayForNewUI();
		ScheduleCommonPage scheduleCommonPage = pageFactory.createScheduleCommonPage();
		SimpleUtils.assertOnFail("'Schedule' sub tab not loaded Successfully!",scheduleCommonPage.verifyActivatedSubTab(ScheduleNewUITest.SchedulePageSubTabText.Schedule.getValue()) , true);
