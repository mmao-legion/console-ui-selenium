...
public class TimeOffRequestTest extends TestBase {
    ...
    public void verifyEmployeeCanRequestAsInternalAdminForEmployeeManagement(String browser, String username, String password, String location) throws Exception {
