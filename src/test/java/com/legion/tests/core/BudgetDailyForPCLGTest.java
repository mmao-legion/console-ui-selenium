...
public class BudgetDailyForPCLGTest extends TestBase {
    ...
    @TestName(description = "Verify the budget values display correct on all pages for PCLG when enable display budget config")
    @Test(dataProvider = "legionTeamCredentialsByRoles", dataProviderClass= CredentialDataProviderSource.class)
    public void verifyBudgetValuesOnAllPagesForPCLGWhenEnableBudgetConfigAsInternalAdmin(String browser, String username, String password, String location) throws Exception {
        try {
