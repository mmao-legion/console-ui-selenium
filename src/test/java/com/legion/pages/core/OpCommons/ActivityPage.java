...
public class ActivityPage extends BasePage{
    ...
    // activity title
    @FindBy(css = "div.notification-bell-popup-header-container")
    ...
    // approve/reject text
    @FindBy(css = "div.notification-approved.ng-binding.ng-scope")
    ...
    public void verifyCancel() throws Exception{
        if(isElementLoaded(approveRejectText.get(0),5)) {
            if (approveRejectText.get(0).getAttribute("innerText").contains("Cancelled")) {
