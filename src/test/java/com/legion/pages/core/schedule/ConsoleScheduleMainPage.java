        ...
        if (isElementLoaded(filterPopup,5)) {
            ...
            if (shiftTypeFilters.size() >= 7) {
                if ((shiftTypeFilters.get(0).getText().contains("Action Required")
                        ...
                        && shiftTypeFilters.get(6).getText().contains("Shift notes")
                        && shiftTypeFilters.get(7).getText().contains("Swap/Cover Requested")
                        && shiftTypeFilters.get(8).getText().contains("Unavailable")
                        && shiftTypeFilters.get(9).getText().contains("Unpublished changes"))||(
                        shiftTypeFilters.get(0).getText().contains("Action Required")
                                ...
                                && shiftTypeFilters.get(5).getText().contains("Shift notes")
                                ...
                                && shiftTypeFilters.get(4).getText().contains("Shift notes")
