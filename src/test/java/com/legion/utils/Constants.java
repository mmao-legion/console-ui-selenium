...
public class Constants {
    public static final String NoLongEligibleTakeShiftErrorMessage = "Error! We're sorry, you're no longer eligible to take this shift.";
    public static final String WillTriggerOTErrorMessage = "Error! We are sorry. You are not eligible to claim this shift, as it will trigger Over Time for the week.";
